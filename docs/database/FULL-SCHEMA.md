...
> Auto-generated: 2026-01-29T07:00:40.979Z
> Total Tables: 80
> PostgreSQL: 17.6
...
| Name | Type | Columns | Unique |
|------|------|---------|--------|
| `idx_repeat_churn` | btree | churn_risk_score | — |
| `idx_repeat_customer_user` | btree | user_id | — |
| `idx_repeat_frequency` | btree | visit_frequency_trend | — |
| `idx_repeat_stage` | btree | conversion_funnel_stage | — |
| `idx_repeat_visits` | btree | visits_last_30_days | — |
| `repeat_customer_analytics_pkey` | btree | id | ✓ |
| `repeat_customer_analytics_user_id_key` | btree | user_id | ✓ |
...
| Name | Type | Columns | Unique |
|------|------|---------|--------|
| `idx_user_engagement_intent` | btree | buying_intent, selling_intent | — |
| `idx_user_engagement_last_active` | btree | last_activity_at | — |
| `idx_user_engagement_score` | btree | engagement_score, intent_score | — |
