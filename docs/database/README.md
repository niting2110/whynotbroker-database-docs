...
> Generated: 2026-01-04T07:01:56.917Z  
> Schema Hash: `5db92d2c1894cba62c3aeb4905dc0b72`
...
- **Last Updated:** 4/1/2026, 12:31:56 pm IST
...
|-------|---------|------|------|---------|
| `admin_audit_logs` | 8 | ~980 | 0.27 MB |  |
...
*...and 122 more (see [relationships.md](./relationships.md))*

## 📈 Performance Insights
- **Largest Table:** `market_trends`
- **Most Columns:** `properties` (124 columns)
- **Total Indexes:** 321
- **Total Constraints:** 638
