...
> Generated: 2026-03-18T07:13:53.556Z
> Schema Hash: `a32dbc10c8753a8c178e82ed67c5ad34`
...
- **Last Updated:** 18/3/2026, 12:43:53 pm IST
...
|-------|---------|------|------|---------|
| `admin_audit_logs` | 8 | ~3,854 | 1.26 MB |  |
...
| `pg_bed` | 7 | ~0 | 0.02 MB |  |
| `pg_occupancy` | 8 | ~0 | 0.01 MB |  |
| `pg_occupancy_snapshot` | 7 | ~0 | 0.02 MB |  |
| `pg_owner_pnl` | 10 | ~0 | 0.02 MB |  |
| `pg_payment_record` | 11 | ~0 | 0.02 MB |  |
| `pg_police_verification` | 8 | ~0 | 0.02 MB |  |
| `pg_posting` | 18 | ~0 | 0.03 MB |  |
| `pg_property` | 18 | ~0 | 0.04 MB |  |
| `pg_receipt` | 5 | ~0 | 0.02 MB |  |
| `pg_rent_agreement` | 13 | ~0 | 0.02 MB |  |
| `pg_room` | 9 | ~0 | 0.02 MB |  |
| `pg_tenant` | 13 | ~0 | 0.02 MB |  |
| `pg_vacancy_event` | 8 | ~0 | 0.02 MB |  |
...
| `property_verifications` | 14 | ~0 | 0.03 MB |  |
...
| `verification_kyc` | 15 | ~0 | 0.04 MB |  |
| `waitlist_entries` | 4 | ~0 | 0.03 MB |  |
| `wallets` | 11 | ~14 | 0.07 MB | "User credit wallets with regio..." |
...
*...and 153 more (see [relationships.md](./relationships.md))*
