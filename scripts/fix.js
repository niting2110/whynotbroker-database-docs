cd C:\whynotbroker-database-docs\scripts

# Create the fix file with proper formatting
$fixContent = @'
// definitive-fixer.js
const fs = require("fs");
...
# Save the fix file
$fixContent | Out-File -FilePath "definitive-fixer.js" -Encoding UTF8

Write-Host "✅ Created definitive-fixer.js"
Write-Host "Now running it..."

# Run the fixer
node definitive-fixer.js